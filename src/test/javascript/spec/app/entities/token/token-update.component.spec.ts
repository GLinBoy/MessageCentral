...
import TokenUpdateComponent from '@/entities/token/token-update.vue';
import TokenClass from '@/entities/token/token-update.component';
...
describe('Component Tests', () => {
  describe('Token Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<TokenClass>(TokenUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.token = entity;
        tokenServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(tokenServiceStub.update.calledWith(entity)).toBeTruthy();
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        tokenServiceStub.retrieve.resolves([foundToken]);
