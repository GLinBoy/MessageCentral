...
describe('Component Tests', () => {
  describe('ShortMessage Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<ShortMessageClass>(ShortMessageComponent, {
        store,
        i18n,
        localVue,
    ...
    it('Should call load all on init', async () => {
      ...
      // WHEN
      comp.retrieveAllShortMessages();
      await comp.$nextTick();

      // THEN
      expect(shortMessageServiceStub.retrieve.called).toBeTruthy();
      expect(comp.shortMessages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(shortMessageServiceStub.retrieve.callCount).toEqual(3);
