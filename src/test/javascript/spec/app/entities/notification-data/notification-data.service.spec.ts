...
describe('Service Tests', () => {
  describe('NotificationData Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a NotificationData', async () => {
      ...
      it('should not update a NotificationData', async () => {
      ...
      it('should not partial update a NotificationData', async () => {
      ...
      it('should not return a list of NotificationData', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should delete a NotificationData', async () => {
      ...
      it('should not delete a NotificationData', async () => {
