...
class NotificationResourceIT {
    ...
    @Test
    @Transactional
    void getAllNotificationsByStatusIsNotEqualToSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.subject(UPDATED_SUBJECT).content(UPDATED_CONTENT).image(UPDATED_IMAGE).status(UPDATED_STATUS);
