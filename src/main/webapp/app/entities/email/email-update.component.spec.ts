...
import EmailUpdate from './email-update.vue';
import EmailService from './email.service';
import { DATE_TIME_LONG_FORMAT } from '@/shared/composables/date-format';
import AlertService from '@/shared/alert/alert.service';

type EmailUpdateComponentType = InstanceType<typeof EmailUpdate>;
...
describe('Component Tests', () => {
  let mountOptions: MountingOptions<EmailUpdateComponentType>['global'];
  let alertService: AlertService;

  describe('Email Management Update Component', () => {
    let comp: EmailUpdateComponentType;
