    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('messageCentralApp.email.emailType')" for="email-emailType">Email Type</label>
            <select
              class="form-control"
              name="emailType"
              :class="{ valid: !$v.email.emailType.$invalid, invalid: $v.email.emailType.$invalid }"
              v-model="$v.email.emailType.$model"
              id="email-emailType"
              data-cy="emailType"
            >
              <option
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('messageCentralApp.email.createdAt')" for="email-createdAt">Created At</label>
            <div class="d-flex">
              <input
                id="email-createdAt"
                data-cy="createdAt"
                ...
                class="form-control"
                name="createdAt"
                :class="{ valid: !$v.email.createdAt.$invalid, invalid: $v.email.createdAt.$invalid }"
                required
                :value="convertDateTimeFromServer($v.email.createdAt.$model)"
                @change="updateInstantField('createdAt', $event)"
              />
            </div>
            <div v-if="$v.email.createdAt.$anyDirty && $v.email.createdAt.$invalid">
              <small class="form-text text-danger" v-if="!$v.email.createdAt.required" v-text="$t('entity.validation.required')">
                This field is required.
              </small>
              <small
                class="form-text text-danger"
                v-if="!$v.email.createdAt.ZonedDateTimelocal"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('messageCentralApp.email.createdBy')" for="email-createdBy">Created By</label>
            <input
              type="text"
              class="form-control"
              name="createdBy"
              id="email-createdBy"
              data-cy="createdBy"
              :class="{ valid: !$v.email.createdBy.$invalid, invalid: $v.email.createdBy.$invalid }"
              v-model="$v.email.createdBy.$model"
              required
            />
            <div v-if="$v.email.createdBy.$anyDirty && $v.email.createdBy.$invalid">
              <small class="form-text text-danger" v-if="!$v.email.createdBy.required" v-text="$t('entity.validation.required')">
                This field is required.
              </small>
            </div>
          </div>
