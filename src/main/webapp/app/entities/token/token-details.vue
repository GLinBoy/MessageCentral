    ...
    <div class="col-8">
      <div v-if="token">
        ...
        <dl class="row jh-entity-details">
          ...
          <dd>
            <span v-if="token.updatedAt">{{ $d(Date.parse(token.updatedAt), 'long') }}</span>
          </dd>
          <dt>
        ...
        <router-link v-if="token.id" :to="{ name: 'TokenEdit', params: { tokenId: token.id } }" custom v-slot="{ navigate }">
