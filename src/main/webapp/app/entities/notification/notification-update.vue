    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('messageCentralApp.notification.createdAt')" for="notification-createdAt"
              >Created At</label
            >
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('messageCentralApp.notification.createdBy')" for="notification-createdBy"
              >Created By</label
            >
            <input
              type="text"
              ...
              data-cy="createdBy"
              :class="{ valid: !$v.notification.createdBy.$invalid, invalid: $v.notification.createdBy.$invalid }"
              v-model="$v.notification.createdBy.$model"
              required
            />
            <div v-if="$v.notification.createdBy.$anyDirty && $v.notification.createdBy.$invalid">
              <small class="form-text text-danger" v-if="!$v.notification.createdBy.required" v-text="$t('entity.validation.required')">
                This field is required.
              </small>
            </div>
          </div>
